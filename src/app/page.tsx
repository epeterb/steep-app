          ...
          {result?.success ? (
            <div className="bg-green-900/50 border border-green-500 rounded-xl p-6 text-center max-w-md mx-auto">
              ...
              <p className="text-gray-300 mb-4">
                Your personal Steep email is:
              </p>
              <div className="bg-gray-800 rounded-lg px-4 py-3 font-mono text-lg text-green-400 mb-4 break-all">
                {result.steep_email}
              </div>
              <p className="text-gray-400 text-sm mb-4">
                Forward LinkedIn posts to this address and they'll appear in your dashboard.
              </p>
              <a 
                href="/dashboard" 
            ...
            <form onSubmit={handleSignup} className="max-w-md mx-auto">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-white text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
