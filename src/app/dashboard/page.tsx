        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 font-mono bg-gray-100 px-3 py-1 rounded mt-1 inline-block">{user?.steep_email}</p>
              <p className="text-sm text-gray-500 mt-2">Forward LinkedIn posts to this address to save them.</p>
            </div>
            <div className="text-right">
              <span className="inline-block bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full">{user?.plan} plan</span>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2">
            ...
            {posts.length === 0 ? (
              <div className="bg-white rounded-xl shadow-sm p-12 text-center">
                ...
                <p className="text-gray-600">Forward your first LinkedIn post to <span className="font-mono text-gray-900">{user?.steep_email}</span></p>
              </div>
            ) : (
