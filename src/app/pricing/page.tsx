      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white rounded-2xl border border-gray-200 p-8">
            ...
            <a href="/login" className="block text-center bg-gray-900 text-white py-3 rounded-xl font-semibold hover:bg-gray-800 transition">
              Get started free
            </a>
          </div>
          ...
          <div className="bg-gray-900 rounded-2xl border border-gray-800 p-8 relative overflow-hidden">
            <div className="absolute top-4 right-4">
              <span className="bg-amber-400 text-gray-900 text-xs font-bold px-3 py-1 rounded-full">EARLY ADOPTER RATE</span>
            </div>
            <div className="mb-6">
              <h2 className="text-xl font-bold text-white mb-1">Pro</h2>
              <p className="text-gray-400 text-sm">When billing goes live</p>
            </div>
            <div className="mb-2">
            ...
            <button disabled className="w-full text-center bg-amber-400 text-gray-900 py-3 rounded-xl font-semibold opacity-75 cursor-not-allowed">
